            ...
            <div class="row">
                <div class="col text-start">
                    <p class="text-uppercase text-secondary">Categorias | 
                        <a href="categoria" class="text-uppercase text-light text-decoration-none">
                            Ver Todos
                        </a>
                    </p>
                </div>
        ...
        <div class="row">
            <div class="col text-start">
                <p class="text-uppercase text-secondary">Produtos | 
                        <a href="produtos" class="text-uppercase text-light text-decoration-none">
                            Ver Todos
                        </a>
                </p>
            </div>
            ...
            <div class="row">
                <div class="col text-start">
                    <p class="text-uppercase text-secondary">Materiais | 
                        <a href="materiais" class="text-uppercase text-light text-decoration-none">
                            Ver Todos
                        </a>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col text-start">
                    <p class="text-uppercase text-secondary">Ferramentas | 
                        <a href="ferramentas" class="text-uppercase text-light text-decoration-none">
                            Ver Todos
                        </a>
                    </p>
                </div>
